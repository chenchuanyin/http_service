...
class ThriftSourceProtocol_ping_args {
 public:

  ThriftSourceProtocol_ping_args() {
  }

  virtual ~ThriftSourceProtocol_ping_args() throw() {}


  bool operator == (const ThriftSourceProtocol_ping_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const ThriftSourceProtocol_ping_args &rhs) const {
  ...
  bool operator < (const ThriftSourceProtocol_ping_args & ) const;
...
class ThriftSourceProtocol_ping_pargs {
 public:


  virtual ~ThriftSourceProtocol_ping_pargs() throw() {}
...
typedef struct _ThriftSourceProtocol_ping_result__isset {
  _ThriftSourceProtocol_ping_result__isset() : success(false) {}
  bool success;
} _ThriftSourceProtocol_ping_result__isset;

class ThriftSourceProtocol_ping_result {
 public:

  ThriftSourceProtocol_ping_result() : success((Status::type)0) {
  }

  virtual ~ThriftSourceProtocol_ping_result() throw() {}

  Status::type success;

  _ThriftSourceProtocol_ping_result__isset __isset;

  void __set_success(const Status::type val) {
    success = val;
  }

  bool operator == (const ThriftSourceProtocol_ping_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const ThriftSourceProtocol_ping_result & ) const;
...
typedef struct _ThriftSourceProtocol_ping_presult__isset {
  _ThriftSourceProtocol_ping_presult__isset() : success(false) {}
  bool success;
} _ThriftSourceProtocol_ping_presult__isset;

class ThriftSourceProtocol_ping_presult {
 public:


  virtual ~ThriftSourceProtocol_ping_presult() throw() {}

  Status::type* success;

  _ThriftSourceProtocol_ping_presult__isset __isset;
...
class ThriftSourceProtocolProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  ThriftSourceProtocolProcessor(boost::shared_ptr<ThriftSourceProtocolIf> iface) :
    ...
    processMap_["ping"] = &ThriftSourceProtocolProcessor::process_ping;
  }
